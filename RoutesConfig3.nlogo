...
to demenage-job
 ;move-to one-of patches with [count turtles-here = 0]
 move-to one-of patches with [count shops-here + count centres-here <= level]
...
to calculate-density
  let density count patches with [count turtles-here = 0]
...
"" ""
PENS
"density" 1.0 0 -16777216 true "" "plot density"
